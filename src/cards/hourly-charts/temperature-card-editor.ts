...
@customElement(TEMPERATURE_CARD_EDITOR_NAME)
export class TemperatureCardEditor extends LitElement implements LovelaceCardEditor {
  ...
  private _valueChanged(ev: CustomEvent): void {
    if (!this._config) this._config = { type: `custom:${TEMPERATURE_CARD_NAME}`, entity: '' };
